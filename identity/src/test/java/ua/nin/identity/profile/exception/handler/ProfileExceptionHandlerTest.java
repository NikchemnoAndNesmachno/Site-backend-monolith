...
class ProfileExceptionHandlerTest {
    ...
    @InjectMocks
    ProfileExceptionHandler handler;
    ...
    void init() {
        ...
        objectMap.put("path", "/api/profile");
    ...
    static Stream<Arguments> notFoundExceptions() {
        return Stream.of(
                Arguments.of(new ProfileNotFoundException("nf"))
        );
    }

    static Stream<Arguments> conflictExceptions() {
        return Stream.of(
                Arguments.of(new UsernameAlreadyTakenException("conflict"))
        );
    }
