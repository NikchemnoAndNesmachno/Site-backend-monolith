...
class CommentExceptionHandlerTest {
    ...
    void testHandleBadRequestException() {
        ...
        assertEquals(handler.handleBadRequest(exception, webRequest),
                ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ExceptionResponse(exception.getMessage())));
    }
