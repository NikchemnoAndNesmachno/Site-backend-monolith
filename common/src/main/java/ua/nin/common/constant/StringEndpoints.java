...
public final class StringEndpoints {
    ...
    public static final String API_V1_USERS_BY_USERNAME = "/api/v1/users/*";

    public static final String API_V1_MEDIA_UPLOAD = "/api/v1/media/upload";
    public static final String API_V1_MEDIA_BY_ID = "/api/v1/media/*";
    public static final String API_V1_MEDIA_BY_ID_META = "/api/v1/media/*/meta";
    ...
    public static final String API_V1_AVATAR_BY_ID = "/api/v1/avatar/*";

    public static final String API_V1_VIDEO_UPLOAD_WITH_PREVIEW = "/api/v1/video/upload/video-with-preview";
    public static final String API_V1_VIDEO_BY_ID = "/api/v1/video/*";

    public static final String API_V1_REACTIONS = "/api/v1/reactions";
    public static final String API_V1_REACTIONS_BY_TARGET_TYPE_BY_TARGET_ID_COUNTS = "/api/v1/reactions/*/*/counts";
    public static final String API_V1_REACTIONS_BY_TARGET_TYPE_BY_TARGET_ID_MY = "/api/v1/reactions/*/*/my";

    public static final String API_V1_COMMENTS = "/api/v1/comments";
    public static final String API_V1_COMMENTS_BY_PARENT_ID_REPLIES = "/api/v1/comments/*/replies";
    public static final String API_V1_COMMENTS_BY_ID = "/api/v1/comments/*";
